    ...
    buildTableBody(data, columns) {
      ...
      data.forEach((row: AchatItem) => {
        ...
        columns.forEach(function (column) {
          ...
          }else if(column== "Prix Unit.HT"){
            dataRow.push(row["unitPrice"]);
          }else if(column== "MONTANT HT"){
        ...
        dd = {
            ...
            ,
          {
            ...
            ,{
              columns: [
                [{
                  text: 'Facture N°: ' + this.facture.ref, style: 'header'
                }, {
                  text: 'Date: ' + this.facture.dateDeFac, style: 'header'
                },{
                  text: 'Commande N°: ' + this.achat.ref, style: 'header'
                },{
                  text: 'Envoyé à', style: 'anotherStyle',
                  bold: true,
                  fontSize: 15,
                },
                {
                  ...
                  text: 'Tél : ' + this.achat.fournisseur.tel, style: 'anotherStyle'
                }
                ],
              ], lineHeight: 2,
            },this.table(this.items, [this.col,this.col1, this.col2, this.col3, this.col4, this.col5, this.col6]),
            {
              columns: [
                [
                  {
                  text: 'TOTAL:   ' +this.achat.total,
                  bold: true,
                  fontSize: 15,
                  margin: [0, 0, 50, 20],
                  alignment: 'right',
              ...
              columns: [
                [
                  {
                  text: 'CONDITIONS ET MODALITES DE PAIEMENT' ,
                  bold: true,
                  fontSize: 10,
                  margin: [0, 90, 0, 20],
                },{
                  text: 'Le paiement est du dans 15 jours',
                  fontSize: 8,
                }, {
